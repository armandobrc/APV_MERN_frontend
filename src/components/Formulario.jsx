...
const Formulario = () => {
    ...
    }, [paciente]) // Observa por los cambios del state para ejecutarse
  ...
  return (
    <>
        ...
        <form className='bg-white py-10 px-5 mb-10 lg:mb-0 shadow-md rounded-md' onSubmit={handleSubmit}>
            ...
            <input type="submit" value={id ? "Guardar Cambios" : "Agregar Paciente"} className='bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 cursor-pointer transition-colors rounded-md'/>
        </form>
    </>
  )
}
